  ...
  render() {
    ...
    return (
      <nav className={`main-nav ${transparent ? "transparent" : ""}`}>
        <div
          className="container d-flex align-center justify-space-between"
                ...
                <Dropdown
                  overlay={() => (
                    <Menu style={{ maxWidth: 300 }}>
                      <Menu.Item>
                        <Icon type="bell" className="mr-2" />
                        <b>Notifications</b>
                      </Menu.Item>
                      {notifications && notifications.length > 0 && (
                        <Menu.Item onClick={() => this.readNoti()}>
                          <span className="t-color-primary">
                            Mark All as Read
                          </span>
                        </Menu.Item>
                      )}
                      ...
                      {notifications && notifications.length > 0 ? (
                        notifications.slice(0, 4).map((e, i) => (
                          <Link to="/client/reservations/">
                            ...
                            >
                              <div
                                className="d-flex align-center pl-3 pr-2"
